public class TriangleLoopsTester {
    public static void main(String[] args) {
        ...
        System.out.println(TriangleLoops.createNumbersTriangle(-28));
        System.out.println(TriangleLoops.createAlphabetTriangle(5));
        System.out.println(TriangleLoops.createAlphabetTriangle(29));
        System.out.println(TriangleLoops.createLetterTriangleDown(3, 'B'));
