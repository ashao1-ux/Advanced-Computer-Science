public class ArrayOpsTester {
    public static void main(String[] args) {
        ...
        String[] arr1 = {"apple", "banana", "kiwi", "orange"};
        System.out.println("Longest String: " + ArrayOps.findLongestString(stringArr1)); 
        // Output: Longest String: banana

        String[] arr2 = {"cat", "dog", "elephant", "lion"};
        System.out.println("Longest String: " + ArrayOps.findLongestString(stringArr2)); 
        // Output: Longest String: elephant

        String[] arr3 = {"red", "green", "blue", "yellow"};
        System.out.println("Longest String: " + ArrayOps.findLongestString(stringArr3)); 
        // Output: Longest String: yellow
        ...
        int[] arr11 = { 1, 2, 3, 4, 5 };
        int[] resizedArr1 = ArrayOps.resizeIntArray(arr11);
        ArrayOps.printIntegerArray(resizedArr1);
        // Output: [1, 2, 3, 4, 5, 0, 0, 0, 0, 0]

        int[] arr21 = { 10, 20, 30 };
        int[] resizedArr2 = ArrayOps.resizeIntArray(arr21);
        ArrayOps.printIntegerArray(resizedArr2);
        // Output: [10, 20, 30, 0, 0, 0]

        int[] arr31 = { 100 };
        int[] resizedArr3 = ArrayOps.resizeIntArray(arr31);
